...
bot.on('message', async (msg) => {
    ...
    switch (message) {
        case '/start':
            ...
            bot.sendMessage(chatId, `Вітаю! 👋 Я бот, який вимірює рік у відсотках. Я дам вам знати, наскільки ми близько до кінця року. Це ваша можливість відчути час ⌛ і цінувати кожен момент! 🚀\n\nВи будете отримувати повідомлення кожного дня. Щоб змінити інтервал повідомлень, скористайтеся кнопками нижче 👇\n\n${progressMsg}`, keyboard);
            break;
        case '/stop':
